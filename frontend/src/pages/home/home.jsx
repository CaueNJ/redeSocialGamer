    ...
    const posts = [
        {
            id: 1,
            titulo: 'Postagem 1',
            urlImg: '/assets/avatar.jpg',
            nome: 'Cauê Nandi Joaquim',
            username: 'CaueNJ',
            avatar: '/assets/avatar.jpg',
            conteudo: 'Esse é meu primeiro post! Testando o layout do feed.',
        },
        {
            id: 2,
            titulo: 'Postagem 2',
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex gap-6 text-gray-500 text-sm mt-3">
                                    ...
                                    <button className="hover:text-pink-500 flex items-center gap-1">
                                        ❤️ <span className="hidden sm:inline">Curtir</span>
                                    </button>
                                </div>
                            </div>
                        </div>
